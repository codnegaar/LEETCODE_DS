...
A cycle is a path of length 4 or more in the grid that starts and ends at the same cell. From a given cell, you can move to one of the cells adjacent to it - in one of the four directions 
    ...
    def containsCycle(self, grid: list[list[str]]) -> bool:
        ...
        def dfs(i: int, j: int, prev_i: int, prev_j: int) -> bool:
            ...
            for di, dj in self.MOVES:
                ...
                # Different cell values case
                if grid[i][j] != grid[next_i][next_j]:
                    continue

                # Neighbor cells cycle case, not valid
